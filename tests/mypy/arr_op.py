...
tests/mypy/arr_op.py:36:13: note: Revealed type is "fastapi_filters.op.FilterOp[builtins.bool]"
...
tests/mypy/arr_op.py:48:13: note: Revealed type is "fastapi_filters.op.FilterOp[typing.Sequence[builtins.int]]"
