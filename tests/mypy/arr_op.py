...
tests/mypy/arr_op.py:34:13: note: Revealed type is "fastapi_filters.op.FilterOp[bool]"
tests/mypy/arr_op.py:35:13: note: Revealed type is "fastapi_filters.op.FilterOp[bool]"
tests/mypy/arr_op.py:36:13: note: Revealed type is "fastapi_filters.op.FilterOp[bool]"
...
tests/mypy/arr_op.py:45:13: note: Revealed type is "fastapi_filters.op.FilterOp[typing.Sequence[int]]"
tests/mypy/arr_op.py:46:13: note: Revealed type is "fastapi_filters.op.FilterOp[typing.Sequence[int]]"
tests/mypy/arr_op.py:47:13: note: Revealed type is "fastapi_filters.op.FilterOp[typing.Sequence[int]]"
tests/mypy/arr_op.py:48:13: note: Revealed type is "fastapi_filters.op.FilterOp[typing.Sequence[int]]"
