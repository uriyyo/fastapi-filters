...
tests/mypy/bool_op.py:36:13: error: Invalid self argument "FilterField[bool]" to attribute function "like" with type "Callable[[FilterOpBuilder[str], str], FilterOp[str]]"  [misc]
tests/mypy/bool_op.py:36:13: note: Revealed type is "fastapi_filters.op.FilterOp[builtins.str]"
tests/mypy/bool_op.py:37:13: error: Invalid self argument "FilterField[bool]" to attribute function "not_like" with type "Callable[[FilterOpBuilder[str], str], FilterOp[str]]"  [misc]
tests/mypy/bool_op.py:37:13: note: Revealed type is "fastapi_filters.op.FilterOp[builtins.str]"
tests/mypy/bool_op.py:38:13: error: Invalid self argument "FilterField[bool]" to attribute function "ilike" with type "Callable[[FilterOpBuilder[str], str], FilterOp[str]]"  [misc]
tests/mypy/bool_op.py:38:13: note: Revealed type is "fastapi_filters.op.FilterOp[builtins.str]"
tests/mypy/bool_op.py:39:13: error: Invalid self argument "FilterField[bool]" to attribute function "not_ilike" with type "Callable[[FilterOpBuilder[str], str], FilterOp[str]]"  [misc]
tests/mypy/bool_op.py:39:13: note: Revealed type is "fastapi_filters.op.FilterOp[builtins.str]"
