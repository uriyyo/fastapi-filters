...
# output:
"""
tests/mypy/str_op.py:13:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
tests/mypy/str_op.py:14:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
...
tests/mypy/str_op.py:21:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
tests/mypy/str_op.py:22:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
...
tests/mypy/str_op.py:34:13: note: Revealed type is "fastapi_filters.op.FilterOp[bool]"
tests/mypy/str_op.py:35:13: note: Revealed type is "fastapi_filters.op.FilterOp[bool]"
tests/mypy/str_op.py:36:13: note: Revealed type is "fastapi_filters.op.FilterOp[bool]"
tests/mypy/str_op.py:39:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
tests/mypy/str_op.py:40:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
tests/mypy/str_op.py:41:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
tests/mypy/str_op.py:42:13: note: Revealed type is "fastapi_filters.op.FilterOp[str]"
